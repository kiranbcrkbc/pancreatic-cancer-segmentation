"""
Model 4 Architecture: CNN + EfficientNet-B3 + 4-Layer GAT (AttnUNetEfficientGAT)
Dual-pathway Attention U-Net:
- 4-stage standard CNN pathway (32 -> 64 -> 128 -> 256)
- Pretrained EfficientNet-B3 backbone pathway (yields 384 fused features at bottleneck)
...
Extracted directly from the verified production implementation in src/models/att_unet_gat.py.
"""
...
class AttnUNetEfficientGAT(nn.Module):
    """
    Model 4 Specification Architecture:
    Attention U-Net + EfficientNet-B3 Backbone + 4-Layer Multi-Head GAT.
    Dual-pathway encoder:
      ...
      - 4-Layer Multi-Head GAT bottleneck (layers 1-3: 4 heads, layer 4: 1 head, hidden_dim 128)
