"""
Evaluation Pipeline for Model 4: CNN + GNN/GAT (AttnUNetEfficientGAT)
...
def run_evaluation(
    ...
    print(f"=== Evaluating Model 4: CNN + GNN/GAT (AttnUNetEfficientGAT) ===")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate Model 4: CNN + GNN/GAT")
