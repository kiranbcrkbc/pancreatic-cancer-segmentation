"""
Model 1 Architecture: CNN + Pyramid Transformer (CNNPyramidTransformerSeg)
...
Extracted directly from the verified production implementation in src/models/cnn_transformer.py.
"""
...
class CNNPyramidTransformerSeg(nn.Module):
    """
    Model 1 Authoritative Architecture:
    Residual CNN Encoder (64 -> 128 -> 256 -> 512)
    + Transformer Bottleneck (PPM + 4 x MHSA)
