"""
Evaluation Pipeline for Model 1: CNN + Pyramid Transformer (CNNPyramidTransformerSeg)
...
class SyntheticEvalDataset(Dataset):
    """Generates synthetic test pairs to verify the evaluation pipeline without external data."""
...
def run_evaluation(
    ...
    print(f"=== Evaluating Model 1: CNN + Pyramid Transformer ===")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate Model 1: CNN + Pyramid Transformer")
