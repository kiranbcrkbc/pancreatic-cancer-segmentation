"""
Training Pipeline for Model 3: CNN + MHSA (CNNMHSASeg)
...
def train_model(
    ...
    print(f"=== Initializing Model 3: CNN + MHSA (CNNMHSASeg) ===")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Model 3: CNN + MHSA")
