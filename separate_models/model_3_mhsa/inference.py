"""
Inference & Interpretability Pipeline for Model 3: CNN + MHSA (CNNMHSASeg)
...
Usage:
    ...
    python inference.py --input /path/to/slice.png --checkpoint ../../checkpoints/mhsa/final_model.pt
"""
...
def run_inference(
    ...
    print(f"=== Model 3: CNN + MHSA Inference ===")
    ...
    plt.suptitle("Model 3 (CNN + MHSA) Clinical Diagnostic Inference", fontsize=13, fontweight="bold")
    plt.tight_layout()
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Inference for Model 3: CNN + MHSA")
