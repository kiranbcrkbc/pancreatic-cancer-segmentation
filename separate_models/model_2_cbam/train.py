"""
Training Pipeline for Model 2: CNN + CBAM (CBAMNet)
...
def train_model(
    ...
    print(f"=== Initializing Model 2: CNN + CBAM (CBAMNet) ===")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Model 2: CNN + CBAM")
