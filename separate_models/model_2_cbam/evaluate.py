"""
Evaluation Pipeline for Model 2: CNN + CBAM (CBAMNet)
...
def run_evaluation(
    ...
    print(f"=== Evaluating Model 2: CNN + CBAM (CBAMNet) ===")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate Model 2: CNN + CBAM")
