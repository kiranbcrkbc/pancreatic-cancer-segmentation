"""
Model Architecture: CNNMHSASeg (CNN + Multi-Head Self-Attention)
Adheres strictly to the supplied 'cnn+mhsa pdf.docx' specification:
...
class CNNMHSASeg(nn.Module):
    """
    Model 2/3 Specification Architecture:
    Residual CNN Encoder (64 -> 128 -> 256 -> 512)
    + Multi-Head Self-Attention Bottleneck (4 Layers, 8 Heads)
    ...
    def forward(
        ...
        # Decoder forward with skip concatenation
        d4 = self.up4(b)
